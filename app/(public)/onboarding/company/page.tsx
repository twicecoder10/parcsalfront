...
export default function CompanyOnboardingPage() {
  ...
  const getCurrentStep = (): number => {
    ...
    if (!isCompanyProfileComplete) return 2; // Step 2: Company Profile
  ...
  // Calculate overall progress (3 main actionable steps: email, profile, payment)
  // Note: profile_completion is automatic, so we count it as part of step 2
  ...
  // For COMPANY_STAFF: Show message that they need to wait for admin to complete company onboarding
              ...
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600 mb-4">
                    You&apos;ve completed all required user steps. Your onboarding will be complete once your company administrator finishes setting up the company profile and payment.
                  </p>
                  <div className="text-sm text-gray-500 mb-6">
                    User Steps: 100% Complete | Company Steps: {companyOnboardingStatus?.progress || 0}% Complete
                  </div>
  ...
  // For COMPANY_STAFF: Redirect if they try to access company profile setup
  if (isStaff && !isCompanyProfileComplete) {
    // Staff can't complete company profile - redirect to dashboard or show message
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-50 via-white to-orange-50">
        <Navbar />
        <div className="flex-1 flex items-center justify-center px-4 py-12">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600 mb-4">
                    Company profile setup can only be completed by a company administrator. Please contact your company admin to complete this step.
                  </p>
                </div>
  ...
  if (isCompanyProfileComplete && !isPaymentSetupComplete) {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-50 via-white to-orange-50">
        <Navbar />
        <div className="flex-1 flex items-center justify-center px-4 py-12">
